...
%\begin{equation}
%$	\boldsymbol{f}_i(\boldsymbol{x},t) = - \frac{1}{2}~ \widehat{C}_{T,i}'(t)~ V_i(t)^2~ \R_i (\boldsymbol{x})~ \boldsymbol{e}_{\perp,i},$
